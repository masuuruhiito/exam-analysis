 ...
 */
@Component
public class ScoreBookHeader implements IExcelHeader {
    ...
    public List<List<String>> getHeader(String teachInfoId) {
        ...
        return new ArrayList<List<String>>() {{
            ...
            addAll(infoDtos.stream()
                    .map(e -> Collections.singletonList(e.getScoreChineseName() + "(" + e.getTotalScore() + ")"))
...
//            add(Collections.singletonList("总评"));
        }};
    }
}
