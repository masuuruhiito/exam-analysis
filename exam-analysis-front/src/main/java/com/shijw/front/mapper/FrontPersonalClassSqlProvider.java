...
import com.shijw.front.model.example.FrontPersonalClassExample.Criteria;
import com.shijw.front.model.example.FrontPersonalClassExample.Criterion;
import com.shijw.front.model.example.FrontPersonalClassExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class FrontPersonalClassSqlProvider {

    public String countByExample(FrontPersonalClassExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("front_personal_class");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(FrontPersonalClassExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("front_personal_class");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(FrontPersonalClass record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("front_personal_class");
    ...
    public String selectByExample(FrontPersonalClassExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FrontPersonalClass record = (FrontPersonalClass) parameter.get("record");
        FrontPersonalClassExample example = (FrontPersonalClassExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("front_personal_class");
    ...
    public String updateByPrimaryKeySelective(FrontPersonalClass record) {
        SQL sql = new SQL();
        sql.UPDATE("front_personal_class");
    ...
    protected void applyWhere(SQL sql, FrontPersonalClassExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
